...
wx.ready(function () {
  ...
  document.querySelector('#onMenuShareAppMessage').onclick = function () {
    wx.onMenuShareAppMessage({
      ...
      link: 'https://wx.yyvan.cn/',
      imgUrl: 'https://wx.yyvan.cn/img/sea.jpg',
  ...
  document.querySelector('#previewImage').onclick = function () {
    wx.previewImage({
      current: 'https://wx.yyvan.cn/img/lake.jpg',
      urls: [
        'https://wx.yyvan.cn/img/sea.jpg'
      ]
    });
  };
  ...
  var shareData = {
    ...
    link: 'https://wx.yyvan.cn/',
    imgUrl: 'https://wx.yyvan.cn/img/lake.jpg'
  };
