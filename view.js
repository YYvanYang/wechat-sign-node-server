...
module.exports = class View extends Readable {
  ...
  constructor(context, signPackage) {
    super();
  ...
  *render() {
    ...
    const body = yield done => {
      setImmediate(() => done(null, `<div class="wxapi_container">
    ...
    this.push(`<script src="https://res.wx.qq.com/open/js/jweixin-1.2.0.js"></script>`);
    ...
    this.push('<script src="js/demo.js"> </script>');
